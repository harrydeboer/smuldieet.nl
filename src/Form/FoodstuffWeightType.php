...
class FoodstuffWeightType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function ($event) {
            ...
            if (is_null($this->foodstuffWeight?->getFoodstuff()->getPieceName())
                || is_null($this->foodstuffWeight->getFoodstuff()->getPieceWeight())) {
                $choices['stuks'] = 'stuks';
            } else {

                $choices[$this->foodstuffWeight->getFoodstuff()->getPieceName()] = 'stuks';
            }
