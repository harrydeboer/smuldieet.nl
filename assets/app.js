...
import {FoodstuffWeights} from "./foodstuff_weights.js";
...
$(function() {
    ...
    let foodstuffWeights = $('.foodstuff-weights-form');
    if (foodstuffWeights.length > 0) {
        new FoodstuffWeights(foodstuffWeights);
    }

    let recipeWeights = $('.recipe-weights-form');
    if (recipeWeights.length > 0) {
        new RecipeWeights(recipeWeights);
    }
});
