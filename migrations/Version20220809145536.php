 ...
 */
final class Version20220809145536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE day (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, timestamp BIGINT DEFAULT NULL, foodstuff_weights VARCHAR(255) NOT NULL, recipe_weights VARCHAR(255) NOT NULL, INDEX IDX_E5A02990A76ED395 (user_id), UNIQUE INDEX timestamp_unique (user_id, timestamp), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, timestamp BIGINT NOT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, tags VARCHAR(255) DEFAULT NULL, ingredients LONGTEXT DEFAULT NULL, preparation_method LONGTEXT NOT NULL, nice_story LONGTEXT NOT NULL, nice_tips LONGTEXT DEFAULT NULL, tools_and_kitchenware LONGTEXT DEFAULT NULL, number_of_persons INT NOT NULL, number_of_pieces INT DEFAULT NULL, rating DOUBLE PRECISION DEFAULT NULL, votes INT NOT NULL, times_saved INT NOT NULL, cooking_time VARCHAR(255) NOT NULL, kitchen VARCHAR(255) NOT NULL, occasion VARCHAR(255) DEFAULT NULL, type_of_dish VARCHAR(255) NOT NULL, is_self_invented TINYINT(1) DEFAULT NULL, vegetarian TINYINT(1) NOT NULL, histamine_free TINYINT(1) NOT NULL, cow_milk_free TINYINT(1) NOT NULL, soy_free TINYINT(1) NOT NULL, gluten_free TINYINT(1) NOT NULL, chicken_egg_protein_free TINYINT(1) NOT NULL, nut_free TINYINT(1) NOT NULL, without_packages_and_bags TINYINT(1) NOT NULL, foodstuff_weights VARCHAR(255) NOT NULL, pending TINYINT(1) NOT NULL, image_extension VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_DA88B1372B36786B (title), UNIQUE INDEX UNIQ_DA88B137F47645AE (url), UNIQUE INDEX UNIQ_DA88B1376FBC9426 (tags), INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
