...
final class Version20230123181354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nutrient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, name_nl VARCHAR(255) NOT NULL, min_rda DOUBLE PRECISION DEFAULT NULL, max_rda DOUBLE PRECISION DEFAULT NULL, unit VARCHAR(255) NOT NULL, decimal_places INT NOT NULL, UNIQUE INDEX UNIQ_A9962C5A5E237E06 (name), UNIQUE INDEX UNIQ_A9962C5A308D8223 (name_nl), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_id INT DEFAULT NULL, timestamp BIGINT NOT NULL, content LONGTEXT DEFAULT NULL, rating INT NOT NULL, is_pending TINYINT(1) NOT NULL, INDEX IDX_D8892622A76ED395 (user_id), INDEX IDX_D889262259D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, timestamp BIGINT NOT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, ingredients LONGTEXT NOT NULL, preparation_method LONGTEXT NOT NULL, number_of_persons INT NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, votes INT NOT NULL, times_saved INT NOT NULL, times_reacted INT NOT NULL, cooking_time VARCHAR(255) NOT NULL, kitchen VARCHAR(255) NOT NULL, occasion VARCHAR(255) DEFAULT NULL, type_of_dish VARCHAR(255) NOT NULL, is_self_invented TINYINT(1) NOT NULL, source VARCHAR(255) DEFAULT NULL, is_vegetarian TINYINT(1) NOT NULL, is_vegan TINYINT(1) NOT NULL, is_histamine_free TINYINT(1) NOT NULL, is_cow_milk_free TINYINT(1) NOT NULL, is_soy_free TINYINT(1) NOT NULL, is_gluten_free TINYINT(1) NOT NULL, is_chicken_egg_protein_free TINYINT(1) NOT NULL, is_nut_free TINYINT(1) NOT NULL, is_without_packages_and_bags TINYINT(1) NOT NULL, is_pending TINYINT(1) NOT NULL, image_extension VARCHAR(255) DEFAULT NULL, INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
