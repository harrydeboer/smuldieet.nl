 ...
 */
final class Version20230126123523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_id INT DEFAULT NULL, page_id INT DEFAULT NULL, created_at BIGINT NOT NULL, updated_at BIGINT DEFAULT NULL, content LONGTEXT NOT NULL, is_pending TINYINT(1) NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526C59D8A214 (recipe_id), INDEX IDX_9474526CC4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_id INT DEFAULT NULL, created_at BIGINT NOT NULL, updated_at BIGINT DEFAULT NULL, content LONGTEXT DEFAULT NULL, rating INT NOT NULL, is_pending TINYINT(1) NOT NULL, INDEX IDX_D8892622A76ED395 (user_id), INDEX IDX_D889262259D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, created_at BIGINT NOT NULL, updated_at BIGINT DEFAULT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, ingredients LONGTEXT NOT NULL, preparation_method LONGTEXT NOT NULL, number_of_persons INT NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, votes INT NOT NULL, times_saved INT NOT NULL, times_reacted INT NOT NULL, cooking_time VARCHAR(255) NOT NULL, kitchen VARCHAR(255) NOT NULL, occasion VARCHAR(255) DEFAULT NULL, type_of_dish VARCHAR(255) NOT NULL, is_self_invented TINYINT(1) NOT NULL, source VARCHAR(255) DEFAULT NULL, is_pending TINYINT(1) NOT NULL, image_extension VARCHAR(255) DEFAULT NULL, is_vegetarian TINYINT(1) NOT NULL, is_vegan TINYINT(1) NOT NULL, is_histamine_free TINYINT(1) NOT NULL, is_cow_milk_free TINYINT(1) NOT NULL, is_soy_free TINYINT(1) NOT NULL, is_gluten_free TINYINT(1) NOT NULL, is_chicken_egg_protein_free TINYINT(1) NOT NULL, is_nut_free TINYINT(1) NOT NULL, is_without_packages_and_bags TINYINT(1) NOT NULL, INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
