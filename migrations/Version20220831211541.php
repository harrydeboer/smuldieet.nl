 ...
 */
final class Version20220831211541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE day (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, timestamp BIGINT DEFAULT NULL, recipe_number_of_times VARCHAR(255) NOT NULL, foodstuff_weights VARCHAR(255) NOT NULL, foodstuff_number_of_pieces VARCHAR(255) NOT NULL, INDEX IDX_E5A02990A76ED395 (user_id), UNIQUE INDEX timestamp_unique (user_id, timestamp), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
