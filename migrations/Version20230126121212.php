 ...
 */
final class Version20230126121212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_id INT DEFAULT NULL, page_id INT DEFAULT NULL, created_at BIGINT NOT NULL, content LONGTEXT NOT NULL, is_pending TINYINT(1) NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526C59D8A214 (recipe_id), INDEX IDX_9474526CC4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cookbook (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, created_at BIGINT NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_BB59C3C3A76ED395 (user_id), UNIQUE INDEX title_unique (user_id, title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, created_at BIGINT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, summary VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, INDEX IDX_140AB620A76ED395 (user_id), UNIQUE INDEX title_unique (title), UNIQUE INDEX slug_unique (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_id INT DEFAULT NULL, created_at BIGINT NOT NULL, content LONGTEXT DEFAULT NULL, rating INT NOT NULL, is_pending TINYINT(1) NOT NULL, INDEX IDX_D8892622A76ED395 (user_id), INDEX IDX_D889262259D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, created_at BIGINT NOT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, ingredients LONGTEXT NOT NULL, preparation_method LONGTEXT NOT NULL, number_of_persons INT NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, votes INT NOT NULL, times_saved INT NOT NULL, times_reacted INT NOT NULL, cooking_time VARCHAR(255) NOT NULL, kitchen VARCHAR(255) NOT NULL, occasion VARCHAR(255) DEFAULT NULL, type_of_dish VARCHAR(255) NOT NULL, is_self_invented TINYINT(1) NOT NULL, source VARCHAR(255) DEFAULT NULL, is_pending TINYINT(1) NOT NULL, image_extension VARCHAR(255) DEFAULT NULL, is_vegetarian TINYINT(1) NOT NULL, is_vegan TINYINT(1) NOT NULL, is_histamine_free TINYINT(1) NOT NULL, is_cow_milk_free TINYINT(1) NOT NULL, is_soy_free TINYINT(1) NOT NULL, is_gluten_free TINYINT(1) NOT NULL, is_chicken_egg_protein_free TINYINT(1) NOT NULL, is_nut_free TINYINT(1) NOT NULL, is_without_packages_and_bags TINYINT(1) NOT NULL, INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recipe_weight (id BIGINT AUTO_INCREMENT NOT NULL, day_id INT DEFAULT NULL, cookbook_id INT DEFAULT NULL, recipe_id INT NOT NULL, value DOUBLE PRECISION NOT NULL, INDEX IDX_8AD34B609C24126 (day_id), INDEX IDX_8AD34B607C8804F (cookbook_id), INDEX IDX_8AD34B6059D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, created_at BIGINT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_389B7835E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, created_at BIGINT NOT NULL, first_name VARCHAR(180) DEFAULT NULL, last_name VARCHAR(180) DEFAULT NULL, username VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, gender VARCHAR(255) NOT NULL, weight DOUBLE PRECISION NOT NULL, birth_time BIGINT NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, image_extension VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE foodstuff_weight ADD CONSTRAINT FK_D3FEA2589C24126 FOREIGN KEY (day_id) REFERENCES day (id)');
        $this->addSql('ALTER TABLE foodstuff_weight ADD CONSTRAINT FK_D3FEA25859D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id)');
        $this->addSql('ALTER TABLE foodstuff_weight ADD CONSTRAINT FK_D3FEA258AEDD2A05 FOREIGN KEY (foodstuff_id) REFERENCES foodstuff (id)');
        ...
        $this->addSql('ALTER TABLE recipe_weight ADD CONSTRAINT FK_8AD34B609C24126 FOREIGN KEY (day_id) REFERENCES day (id)');
        $this->addSql('ALTER TABLE recipe_weight ADD CONSTRAINT FK_8AD34B607C8804F FOREIGN KEY (cookbook_id) REFERENCES cookbook (id)');
        $this->addSql('ALTER TABLE recipe_weight ADD CONSTRAINT FK_8AD34B6059D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE foodstuff_weight DROP FOREIGN KEY FK_D3FEA2589C24126');
        $this->addSql('ALTER TABLE foodstuff_weight DROP FOREIGN KEY FK_D3FEA25859D8A214');
        $this->addSql('ALTER TABLE foodstuff_weight DROP FOREIGN KEY FK_D3FEA258AEDD2A05');
        ...
        $this->addSql('ALTER TABLE recipe_weight DROP FOREIGN KEY FK_8AD34B609C24126');
        $this->addSql('ALTER TABLE recipe_weight DROP FOREIGN KEY FK_8AD34B607C8804F');
        $this->addSql('ALTER TABLE recipe_weight DROP FOREIGN KEY FK_8AD34B6059D8A214');
